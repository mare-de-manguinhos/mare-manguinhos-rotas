...
const carlosDeliveries: Delivery[] = [
  {
    ...
    pickupAddress: 'Rua Timbó, 120 - Bonsucesso, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Nova Holanda, 328 - Complexo da Maré, Rio de Janeiro - RJ',
  ...
  },
  {
    ...
    pickupAddress: 'Av. Brasil, 4365 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Rubens Vaz, 45 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 22.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Rua Leopoldo Bulhões, 1480 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua da Bela Vista, 78 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 15.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Av. Dom Hélder Câmara, 1500 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Itamarati, 150 - Benfica, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 28.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Rua Gravatai, 23 - Bonsucesso, Rio de Janeiro - RJ',
    deliveryAddress: 'Av. Rio de Janeiro, 500 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 20.5,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Av. Suburbana, 1200 - Del Castilho, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Nova Holanda, 89 - Complexo da Maré, Rio de Janeiro - RJ',
...
const marcosDeliveries: Delivery[] = [
  {
    ...
    pickupAddress: 'Rua Timbó, 250 - Bonsucesso, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Rubens Vaz, 120 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 19.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Av. Brasil, 5200 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua da Bela Vista, 150 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 24.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Rua Leopoldo Bulhões, 900 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Av. Rio de Janeiro, 780 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 17.5,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Av. Dom Hélder Câmara, 800 - Manguinhos, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Nova Holanda, 450 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 31.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Rua Gravatai, 78 - Bonsucesso, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Rubens Vaz, 200 - Complexo da Maré, Rio de Janeiro - RJ',
    status: DeliveryStatus.PENDING,
    price: 21.0,
    coordinates: {
  ...
  },
  {
    ...
    pickupAddress: 'Av. Suburbana, 600 - Del Castilho, Rio de Janeiro - RJ',
    deliveryAddress: 'Rua Itamarati, 300 - Benfica, Rio de Janeiro - RJ',
    status: DeliveryStatus.COMPLETED,
    price: 38.0,
    coordinates: {
